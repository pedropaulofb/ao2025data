...
def execute_visualization_coverage_percentage_group(in_dir_path, out_dir_path, file_path):
    ...
    plt.title('Group-wise Coverage vs. Top Percentages of Constructs', fontsize=14, fontweight='bold')
    plt.xlabel('Percentage of Constructs Considered (%)', fontsize=12)
    plt.ylabel('Total Group-wise Coverage of Construct Occurrences', fontsize=12)
    ...
    fig_name = 'groupwise_coverage_vs_construct_percentage.png'
