...
from backup.src.ClassStereotypesData import ClassStereotypesData
from backup.src.RelationStereotypesData import RelationStereotypesData
from backup.src.SPOStats import SPOStats
from backup.src.generate_stats import read_csv_and_update_instances, write_stats_to_csv
...
def consolidate_spo() -> None:
    ...
    read_csv_and_update_instances('backup/outputs/queries_results/query_spo_consolidated.csv', models_stats)

    # Specify the output CSV file path
    output_file = "backup/outputs/consolidated_spo.csv"
...
if __name__ == "__main__":
    consolidate_stereotypes_data("class",
                                 ...
                                 "backup/outputs/queries_results/ontouml_no_classroom_after_2015/query_c_consolidated.csv",
                                 "backup/outputs/consolidated_data/cs_ontouml_no_classroom_after_2015.csv")
    consolidate_stereotypes_data("relation",
                                 "./outputs/loaded_models/ontouml_no_classroom_after_2015.txt",
                                 "outputs/queries_results/ontouml_no_classroom_after_2015/query_rs_consolidated.csv",
                                 "backup/outputs/queries_results/ontouml_no_classroom_after_2015/query_r_consolidated.csv",
                                 "backup/outputs/consolidated_data/rs_ontouml_no_classroom_after_2015.csv")
