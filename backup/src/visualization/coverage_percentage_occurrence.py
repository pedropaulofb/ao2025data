...
def execute_visualization_coverage_percentage_occurrence(in_dir_path, out_dir_path, file_path):
    ...
    plt.title('Coverage vs. Top Percentages of Stereotypes', fontsize=14, fontweight='bold')
    plt.xlabel('Percentage of Stereotypes Considered (%)', fontsize=12)
    plt.ylabel('Total Coverage of Stereotype Occurrences', fontsize=12)
    ...
    fig_name = 'coverage_vs_stereotype_percentage.png'
