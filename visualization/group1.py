...
def execute_visualization_group1(file_path):
    ...
    ax2 = ax1.twinx()
    ax2.bar([i + 0.4 for i in range(len(df))], df['Ubiquity Index (Group Frequency per Group)'], color='salmon',
            width=0.4, label='Ubiquity Index')
