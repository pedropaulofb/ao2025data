...
from src.visualization.coverage_percentage_group import execute_visualization_coverage_percentage_group
from src.visualization.coverage_percentage_occurrence import execute_visualization_coverage_percentage_occurrence
...
from src.visualization.hybrid_analyses import execute_visualization_mutual_info_vs_jaccard_similarity, \
    ...
    execute_visualization_mutual_info_vs_dice_coefficient, execute_visualization_coverage_percentage_all, \
    execute_visualization_pareto_combined
...
from src.visualization.rank_frequency_distribution_group import execute_visualization_rank_frequency_distribution_group
from src.visualization.rank_frequency_distribution_occurrence import execute_visualization_rank_frequency_distribution_occurrence
...
def create_visualizations(input_dir: str):
    ...
    execute_visualization_pareto_combined(input_dir, output_dir, 'rank_frequency_distribution.csv',
                                                          'rank_groupwise_frequency_distribution.csv')
...
if __name__ == "__main__":
    ...
    # execute_visualization_movement(path_file_A, path_file_B, out_dir_path)
    #
    # # TIME COMPARISON RELATION
    # path_file_A = './outputs/statistics/rs_ontouml_no_classroom_until_2017_f/frequency_analysis.csv'
